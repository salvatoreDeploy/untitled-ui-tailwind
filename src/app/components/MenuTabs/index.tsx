      ...
      <ScrollArea.Root className='w-full' type='scroll'>
        <ScrollArea.Viewport className='w-full overflow-x-scroll'>
          <Tabs.List className='mt-6 flex w-full items-center gap-4 border-b border-zinc-200 dark:border-zinc-700'>
            ...
            <TabItem value='tab7' title='E-mail' isSelected={currentTab === 'tab7'} />
            ...
            <TabItem value='tab10' title='APIs' isSelected={currentTab === 'tab10'} />
          </Tabs.List>
        </ScrollArea.Viewport>

        <ScrollArea.Scrollbar className='flex h-0.5 -translate-y-1.5 touch-none flex-col bg-zinc-200' orientation='horizontal'>
          <ScrollArea.Thumb className='relative flex-1 rounded-lg bg-zinc-400' />
